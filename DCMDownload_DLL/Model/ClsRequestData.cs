...
namespace DCMDownload_DLL.Model
{
    public class ClsRequestData
    {
        ...
        public string acct_owner_offphnum { get; set; }
        ...
        public string comp_fininmpl  { get; set; }
        public string comp_cat { get; set; }
        public string complainant_subcat { get; set; }
        public string comp_subj { get; set; }
        public string comp_subcat { get; set; }
        public string addr_2_comp { get; set; }
        public string addr_1_comp { get; set; }
